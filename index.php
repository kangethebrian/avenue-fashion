      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0719441167">0719441167</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:kangethebrian0@gmail.com" class="email__addr">kangethebrian0@gmail.com</a>
            </div>
          </div>
      ...
      <div class="banners">
        <div class="container clearfix">
          ...
          <div class="banner-social">
            <a href="http://www.facebook.com" class="banner-social__link">
            <i class="icon-facebook"></i>
          </a>
            <a href="http://www.twitter.com" class="banner-social__link">
            <i class="icon-twitter"></i>
          </a>
            <a href="http://www.instagram.com" class="banner-social__link">
